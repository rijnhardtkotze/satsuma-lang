...
- `workspace-index.ts` in `satsuma-lsp` is an LSP-facing wrapper.
- It delegates shared indexing operations to `@satsuma/viz-backend`.
- Together, these index paths power definitions, references, and completion lookups.
